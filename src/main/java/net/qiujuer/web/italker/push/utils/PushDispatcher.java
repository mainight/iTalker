...
public class PushDispatcher {
    private static final String appId = "RjjvCqCs1r6uhABcRPaRT";
    private static final String appKey = "TbhV9Q53Cu9GjlDewVbmv3";
    private static final String masterSecret = "aKMF0z0yAy6eWb3nJCGfz5";
